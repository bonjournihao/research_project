-Use saveImage_us saveImage_fr saveImage to download the us,fr,nz newspapers.
...
US: (number of newspapers:31)
0-25,30-35 in us_list_fewer.txt
...
New Zealand: (number:37)
0-36 in newzealand_list.txt

France: (number:40)
0-39 (all) in french_list.txt
